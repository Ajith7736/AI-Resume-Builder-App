...
const Resume = () => {
    ...
    return (
        <SafeAreaView className='h-screen-safe  relative bg-light-gray dark:bg-dark-black'>
            ...
            <Pressable className=' dark:bg-dark-inputfield bg-light-activeborder/10 p-5 border border-light-activeborder/20 transition-all w-[60px] flex justify-center items-center absolute bottom-10 left-5 ease-in-out duration-300 rounded-md' onPress={() => setshowresume(!showresume)}>
